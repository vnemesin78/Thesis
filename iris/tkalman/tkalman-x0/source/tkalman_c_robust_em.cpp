#include "tkalman_c_robust_em.hpp"
 ...
 */
void tkalman_c_robust_em  :: filter(const gsl_vector * const * observations,
                                     unsigned int nb_observations)
{
	...
	//Algorithme EM
	tkalman_c_robust_em :: do_em_algorithm(observations);
	//Filtrage
...
/**@fn virtual void tkalman_c_robust_em :: smooth(const gsl_vector * const * observations,
                                                  unsigned int nb_observations)
 * @param[in] observations : observations
 * @param[in] nb_observations : nombre d'observations
 * @brief
 ...
 */
void tkalman_c_robust_em :: smooth(const gsl_vector * const * observations,
                                     unsigned int nb_observations)
{
	if (nb_observations != _n)
	{
...
/**@fn bool tkalman_c_robust_em  :: operator!()
 * @return
...
**/
bool tkalman_c_robust_em :: operator!() const
{
    return (tkalman_robust_em  :: operator !() || _size_x == _size_y);
}


/**@fn void tkalman_c_robust_em  do_em_algorithm(const gsl_vector * const * observations);
 * @param[in] observations : observations
 * @brief
 * Cette méthode estime les paramètres du filtre de Kalman couple à partir d'un jeu d'observations.
 */
void tkalman_c_robust_em   :: do_em_algorithm(const gsl_vector * const * observations)
{
...
/**@fn tkalman_c_robust_em  :: tkalman_c_robust_em (const gsl_vector * x0,
                                                  const gsl_matrix * p0,
                                                  const gsl_matrix * f,
                                                  const gsl_matrix * q,
                                                  unsigned int n = 0,
 ...
 * Constructeur
*/
tkalman_c_robust_em  ::tkalman_c_robust_em (const gsl_vector * x0,
                                              const gsl_matrix * p0,
                                              const gsl_matrix * f,
                                              const gsl_matrix * q,
                                              unsigned int n,
                                              unsigned int p,
                                              bool data)
: tkalman_robust_em :: tkalman_robust_em(x0, p0, f, q, n, p, data)
{};
