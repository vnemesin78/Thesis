#ifndef KALMAN_C_ROBUST_EM_HPP_INCLUDED
    #define KALMAN_C_ROBUST_EM_HPP_INCLUDED
	#include "kalman_robust_em.hpp"
    /**@class kalman_c_robust_em
    *@brief
    ...
    **/
    class kalman_c_robust_em : public kalman_robust_em
    {
        public:
			/**@fn kalman_c_robust_em :: tkalman_x_original_em(const gsl_vector * x0,
															  const gsl_matrix * p0,
															  const gsl_matrix * f,
															  const gsl_matrix * q,
															  unsigned int n = 0,
			 ...
			 * Constructeur
			*/
			kalman_c_robust_em(const gsl_vector * x0,
...
#endif // kalman_c_robust_em_HPP_INCLUDED
