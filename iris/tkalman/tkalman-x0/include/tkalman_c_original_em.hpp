#ifndef TKALMAN_C_ORIGINAL_EM_HPP_INCLUDED
    #define TKALMAN_C_ORIGINAL_EM_HPP_INCLUDED
    #include "tkalman_original_em.hpp"
    /**@class tkalman_c_orignal_em
    *@brief
    ...
    **/
    class tkalman_c_original_em : public tkalman_original_em
    {
        public:
			 ...
			 * Constructeur
			*/
			tkalman_c_original_em(const gsl_vector * x0,
							      const gsl_matrix * p0,
								  const gsl_matrix * f,
								  const gsl_matrix * q,
								  unsigned int n = 0,
...
#endif // TKALMAN_C_ORIGINAL_EM_HPP_INCLUDED
