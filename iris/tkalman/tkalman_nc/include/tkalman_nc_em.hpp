/**@file tkalman_nc_em.hpp
 * @author Valérian Némesin
 * 
 */
#ifndef _TKALMAN_NC_EM_HPP_
	#define _TKALMAN_NC_EM_HPP_
	 ...
	 * 
	 */
	class tkalman_nc_em : public tkalman_nc_em_base
	{
		public:
			/**@fn
			 ...
			 * Constructeur
			**/
			tkalman_nc_em(	const gsl_vector * t0,
			 ...
			 * @param[in] sqrt_q : [Q]^{\frac{1}{2}}, racine de la matrice de covariance du bruit
			**/
			void set_params( const gsl_vector * t0,
							 const gsl_matrix * sqrt_q0,
							 const gsl_matrix * f,
							 const gsl_matrix * sqrt_q );
