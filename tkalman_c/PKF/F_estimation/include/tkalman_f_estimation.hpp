...
public:
	 ...
	 * - 0 known block
	 * - 1 \f$ F_i = M_i * G_i \f$ where \f$ G_i \f$ a matrix contained in other_data[i];
	 * - 2 \f$ F_i = \lambda_i * G_i \f$ where \f$ \lambda_i \f$ and G_i is a matrix contained in other_data[i]
