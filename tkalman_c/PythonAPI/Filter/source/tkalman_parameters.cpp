...
BOOST_PYTHON_MODULE(filter) {
    bn::initialize();
	class_<parameters>("parameters", &parameters_py_constructor)
	.def("setup", &parameters_py_setup)
	.def("setup_from_size", &parameters :: setup(int&, int&))
	.def("reset", &parameters :: reset)
	.def("transform", &parameters_py_transform)
	.add_property("size_x", &parameters :: size_x)
	.add_property("size_x", &parameters :: size_y)
	.add_property("size_t", &parameters :: size_t)
	.add_property("t_0", &parameters_py_get_t_0, &parameters_py_set_t_0)
	.add_property("q_0", &parameters_py_get_q_0, &parameters_py_set_q_0)
	.add_property("sqrt_q_0", &parameters_py_get_sqrt_q_0, &parameters_py_set_sqrt_q_0)
	.add_property("q", &parameters_py_get_q, &parameters_py_set_q)
	.add_property("sqrt_q", &parameters_py_get_sqrt_q, &parameters_py_set_sqrt_q)
	.add_property("sqrt_q_xx", &parameters_py_get_sqrt_q_xx, &parameters_py_set_sqrt_q_xx)
	.add_property("sqrt_q_xy", &parameters_py_get_sqrt_q_xy, &parameters_py_set_sqrt_q_xy)
	.add_property("sqrt_q_yy", &parameters_py_get_sqrt_q_yy, &parameters_py_set_sqrt_q_yy)
	.add_property("f", &parameters_py_get_f, &parameters_py_set_f)
	.add_property("f_xx", &parameters_py_get_f_xx, &parameters_py_set_f_xx)
	.add_property("f_xy", &parameters_py_get_f_xy, &parameters_py_set_f_xy)
	.add_property("f_xt", &parameters_py_get_f_xt, &parameters_py_set_f_xt)
	.add_property("f_yx", &parameters_py_get_f_yx, &parameters_py_set_f_yx)
	.add_property("f_yy", &parameters_py_get_f_yy, &parameters_py_set_f_yy)
	.add_property("f_yt", &parameters_py_get_f_yt, &parameters_py_set_f_yt)
